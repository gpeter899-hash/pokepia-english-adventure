...
- 天氣、心情與簡單對話
- 國小四年級程度短文理解 BOSS 關
- 國小 1-4 年級核心生活字庫任務：數字、顏色、教室、家庭、動物、身體、食物、日常動作、天氣、衣物、居家、地點、時間、交通、運動、形容詞、問句與位置詞等主題

## 字庫來源方向

字庫以教育部國中小英語參考字彙的生活高頻詞方向為基礎，並依國小常見教材主題重新整理為遊戲用資料。康軒、翰林等教材可作為主題與學習順序參考，但本專案不直接複製任何出版社課本的完整字表或編排。
